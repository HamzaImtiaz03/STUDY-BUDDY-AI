...
2. Create a new repository, e.g., `Hamzaimtiaz03/STUDY-BUDDY-AI`
...
1. Go to **Jenkins → Manage Jenkins → Credentials → Global → Add Credentials**
   - **Username**: DockerHub username (e.g., `Hamza Imtiaz`)
...
`https://github.com/HamzaImtiaz03/STUDY-BUDDY-AI`
...
2. Fill in details:
   ...
   * **Project:** default
   * **Repo URL:** `https://github.com/Hamzaimtiaz03/GitOPS-testing.git`
